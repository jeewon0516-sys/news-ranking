...
CATEGORIES: Dict[str, List[str]] = {
    "카드": [
        "KB국민카드", "롯데카드", "BC카드", "신한카드", "우리카드",
        "KB캐피탈", "현대캐피탈", "하나카드", "현대카드",
    ],
    "은행": [
        "NH농협은행", "KB국민은행", "KB금융지주", "하나금융지주", "BNK경남은행",
        "광주은행", "기술보증기금", "기업은행", "농협금융지주", "농협상호금융기획부",
        "농협중앙회", "부산은행", "새마을금고", "수출입은행", "수협상호금융부",
        "신용보증기금", "신한금융지주", "신한은행", "신협중앙회", "KDB산업은행",
        "우리은행", "저축은행중앙회", "LH한국토지주택공사", "제주은행", "전국은행연합회",
        "웰컴저축은행", "수협은행",
    ],
    "증권": [
        "DB증권", "KB증권", "NH투자증권", "SK증권", "금융투자협회",
        "대신증권", "메리츠증권", "미래에셋증권", "미래에셋자산운용", "삼성자산운용",
        "삼성증권", "신한투자증권", "아주아이비투자", "유안타증권", "이지스자산운용",
        "하나증권", "IM증권", "한국예탁결제원", "한국투자증권", "한화투자증권",
        "현대차증권", "에이치알자산운용", "유진투자증권", "한양증권", "한국증권금융",
    ],
}
